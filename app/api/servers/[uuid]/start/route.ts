...
export async function POST(req: NextRequest, ctx: Ctx) {
  try {
    ...
    if (!rateLimit(`power:start:${ctx.params.uuid}`, RL.powerOp)) {
    ...
    const result = await startInstance(resellerId, ctx.params.uuid, {
